...
public static String str1= "test.txt";
 ...
 DefaultListModel model = new DefaultListModel();
    ...
    public tcpclient() throws SocketException, UnknownHostException, IOException {
...
while(count!=0){
    ...
    private void initComponents() {
        ...
        jButton1.setText("connect with udp server");
        ...
        jLabel14.setText("error genarate added to the file");
...
int randomNum = rand.nextInt((1000) + 1) ;
   ...
   /*   try { 
     ...
     sta.append("recive ack "+ ack );
       sta.append("Retransmissions  "+ ack+1 );
      ppacket++; 
      ack ++; 
					}
				} catch (IOException e1) {
...
StyleConstants.setForeground(style, Color.blue);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         int po = Integer.parseInt(portfile.getText());
       try {
           socket = new Socket("127.0.0.1", po);
       } catch (IOException ex) {
           Logger.getLogger(tcpclient.class.getName()).log(Level.SEVERE, null, ex);
       }
